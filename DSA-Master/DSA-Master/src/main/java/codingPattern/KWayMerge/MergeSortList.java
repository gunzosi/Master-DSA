...
import codingPattern.KWayMerge.Helper.*;
...
public class MergeSortList {
    ...
    public static void main(String[] args) {
        ...
        List<List<List<Integer>>> inputLists = Arrays.asList(
                ...
                Arrays.asList(List.of(2), Arrays.asList(1, 2, 4), Arrays.asList(25, 56, 66, 72)),
                Arrays.asList(Arrays.asList(11, 41, 51), List.of(2), List.of(2), List.of(2), Arrays.asList(1, 2, 4)),
